...
export default {
    ...
    async execute(message) {
        ...
        // Check if messages contain "bored fish"
        if (message.content.toLowerCase().includes("bored fish") || message.content.toLowerCase().includes("boredfish") || message.content.toLowerCase().includes("spongebob") || message.content.toLowerCase().includes("sponge bob")) {
